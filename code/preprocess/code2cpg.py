...
output_path = "../dataset/PROMISE/apache-ant-1.6.0-binTemp" # bin 和 zip 都可以
...
for java_file in tqdm(java_files, desc="Processing Java Files"):
    ...
    # 构造输出文件名
    cpg_file = os.path.join(output_path, f"{file_name}.cpg.bin")
    ...
    # 构建 javasrc2cpg 命令
    command = [
        "D:\\CPDP\\joern-cli\\javasrc2cpg.bat", # 这里要用绝对路径
        java_file,
        "--output",
        cpg_file
    ]
